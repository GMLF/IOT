...
Adafruit_BME280 bme;
/*Iniciando o sensor bme 280, declarando variaveis para armazenar os dados do sensor
 */
int temperatura;
int umidade;
int pressao;
...
void loop() {
    ...
    os_runloop_once();
//declarando o tempo de leitura do sensor//
    tempoatual = millis();
    //fazendo com que o sensor realize a leitura dos dados a cada dois segundos//
    if(tempoatual - tempoanterior>= 2000){
      ...
      Serial.println("hPa");
     //lendo a presão e realizando a conversão para ser exibida//
      pressao =  bme.readPressure() / 100.0F;
      
      Serial.print("Humidity = ");
      Serial.print(bme.readHumidity());
      Serial.println("%");
      //lendo os dados da humidade//
